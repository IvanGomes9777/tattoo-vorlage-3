  ...
  return (
    <section data-hero className="relative flex min-h-[100svh] items-center overflow-hidden">
      ...
      <div className="absolute inset-0 -z-10 bg-oxblood-deep">
        ...
        {/* Legibility overlays (über dem Video) – garantieren Kontrast für den Text */}
        <div className="absolute inset-0 bg-gradient-to-r from-oxblood-deep/92 via-oxblood-deep/68 to-transparent" />
